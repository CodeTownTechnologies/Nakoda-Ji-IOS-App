...
class ParentVC: UIViewController{
    ...
    fileprivate func setupViewAppearance() {
        ...
        self.navigationController?.navigationBar.titleTextAttributes = [NSAttributedString.Key.font:CFontPoppins(size: 18, type: .Bold), NSAttributedString.Key.foregroundColor:ColorWhite_FFFFFF]
...
class ParentPageVC: UIPageViewController{
